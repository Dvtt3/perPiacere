                                        ...
                                        <form action='php/logIn.php' method='POST'>
                                           <fieldset>
                                              ...
                                              <div class='field center'>
                                                <input type='submit' name='button' style='background: #72dd78; color:black; font-size:x-large; font-weight: 350;' value='Log In!'/>
                                           </fieldset>
                                           <div>
                                             <a href='Register.html'  style='margin-left: 100px; color: #72dd78;'>Don't have an account? Register!</a>
                                            </div>
                       ...
                       <div class='row'>
                        ...
                        <div class='col-lg-9 site_information'>
                           <div class='full'>
                               <div class='top_section_info'>
                                  <ul>
                                    <li>Contact Us: <img src='images/i1.png' alt='#' /> <a href='php/oAuthLogOut.php'>".$_SESSION["user_first_name"]."</a></li>
                                    <li><img src='images/i2.png' alt='#' /> <a href='#'>honey@gmail.com</a></li>
                                    <li><img src='images/i3.png' alt='#' /> <a href='#'>104 New york , USA</a></li>
                                 </ul>
                               </div>
